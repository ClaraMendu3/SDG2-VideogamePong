...
typedef struct {
  ...
  tipo_raqueta raquetaSuperior;
  tipo_raqueta raquetaInferior;
  tipo_pelota pelota;
} tipo_arkanoPi;

//Hacemos las pantallas extern para poder usarlas en arkanoPi_1.c
extern tipo_pantalla bienvenida;
extern tipo_pantalla stop;
extern tipo_pantalla bienvenida;
extern tipo_pantalla go;
extern tipo_pantalla cero_uno;
extern tipo_pantalla uno_cero;
extern tipo_pantalla uno_uno;
extern tipo_pantalla unos_dos;
extern tipo_pantalla dos_uno;
extern tipo_pantalla dos_cero;
extern tipo_pantalla cero_dos;
extern tipo_pantalla uno_dos;
